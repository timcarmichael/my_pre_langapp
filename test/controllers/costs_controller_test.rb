...
class CostsControllerTest < ActionController::TestCase
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post :create, cost: { cost: @cost.cost, description: @cost.description, supplier: @cost.supplier }
    end
  ...
  test "should update cost" do
    patch :update, id: @cost, cost: { cost: @cost.cost, description: @cost.description, supplier: @cost.supplier }
    assert_redirected_to cost_path(assigns(:cost))
  end
